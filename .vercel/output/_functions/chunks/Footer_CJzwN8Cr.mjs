import { c as createComponent, a as createAstro, m as maybeRenderHead, b as addAttribute, r as renderSlot, d as renderTemplate, f as renderComponent } from './astro/server_N88lyJG8.mjs';
import 'kleur/colors';
import 'clsx';
...
}, "C:/Users/consc/OneDrive/Desktop/consultorias-cap/src/components/NavLink.astro", void 0);

const $$NavBar = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<div class="sticky top-0 z-50 bg-white/30 backdrop-blur-sm"> <nav class="container mx-auto"> <div class="flex justify-between py-2 items-center"> <a href="/"> <img src="/logo-capital.png" alt="logo" class="h-16"> </a> <ul class="flex gap-8"> <li> ${renderComponent($$result, "NavLink", $$NavLink, { "href": "/" }, { "default": ($$result2) => renderTemplate`inicio` })} </li> <li> ${renderComponent($$result, "NavLink", $$NavLink, { "href": "/quienes-somos" }, { "default": ($$result2) => renderTemplate`quienes somos` })} </li> <li> ${renderComponent($$result, "NavLink", $$NavLink, { "href": "/nuestros-servicios" }, { "default": ($$result2) => renderTemplate`nuestros servcicios` })} </li> <li> ${renderComponent($$result, "NavLink", $$NavLink, { "href": "/soluciones" }, { "default": ($$result2) => renderTemplate`soluciones` })} </li> <li> ${renderComponent($$result, "NavLink", $$NavLink, { "href": "/contacto" }, { "default": ($$result2) => renderTemplate`contacto` })} </li> </ul> </div> </nav> </div>`;
}, "C:/Users/consc/OneDrive/Desktop/consultorias-cap/src/components/layout/NavBar.astro", void 0);

const $$Footer = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<footer class="flex flex-col justify-center py-12 bg-black text-white gap-8"> <div class="container mx-auto px-4 md:px-0 flex flex-wrap gap-16 lg:justify-between"> <h2 class="text-3xl lg:text-4xl font-bold">Consultorias Capital</h2> <div class="flex flex-wrap gap-4 lg:gap-24"> <!-- <ul class="flex flex-col gap-2">
